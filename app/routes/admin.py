...
from app.models import User, Prospection, SUPPLIERS
...
# Dérivé de SUPPLIERS : un fournisseur archivé (ex: Nova Pharma) n'est plus
# comptabilisé dans les KPI globaux ni les rapports de CA.
