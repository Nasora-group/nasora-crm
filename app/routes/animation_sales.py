...
def my_history():
    ...
    pharmacy_query = _animation_sales_query().with_entities(AnimationSale.pharmacy_name).distinct()
    pharmacies = sorted({row[0] for row in pharmacy_query.all() if row[0]})
