...
class Prospection(db.Model):
    id=db.Column(db.Integer,primary_key=True); commercial_id=db.Column(db.Integer,db.ForeignKey("user.id"),nullable=False,index=True); date=db.Column(db.Date,nullable=False,index=True); nom_client=db.Column(db.String(150),nullable=False); specialite=db.Column(db.String(150),nullable=False); structure=db.Column(db.String(150),nullable=False); establishment=db.Column(db.String(200),nullable=True,index=True); telephone=db.Column(db.String(30),nullable=False); profils_prospect=db.Column(db.Text,nullable=True); produits_presentes=db.Column(db.Text,nullable=True); produits_prescrits=db.Column(db.Text,nullable=True); client_id=db.Column(db.Integer,db.ForeignKey("crm_client.id"),nullable=True,index=True); planning_id=db.Column(db.Integer,db.ForeignKey("planning.id"),nullable=True,index=True); planning_day=db.Column(db.String(20),nullable=True)
